  ...
  return (
    <div className="min-h-screen bg-[#F8F5F0] font-sans selection:bg-[#F07154]/20 selection:text-[#33251E]">
      ...
      <main className="ml-0 lg:ml-[280px] pt-[112px] pb-12 px-4 lg:px-8 max-w-[1600px] mx-auto flex flex-col">
        ...
        {/* Main Map Row */}
        <div className="grid grid-cols-1 xl:grid-cols-[7fr_3fr] gap-6 mb-6 items-stretch">
          
          {/* Map Card */}
          <div className="bg-white rounded-2xl shadow-sm border border-[#33251E]/10 flex flex-col overflow-hidden h-[560px] relative">
             <div className="absolute top-6 left-6 z-10 bg-white/90 backdrop-blur-sm p-4 rounded-xl border border-[#33251E]/10 shadow-sm pointer-events-none">
                <h3 className="font-serif text-xl font-bold text-[#33251E]">Live Rescue Map</h3>
                <p className="text-xs text-[#33251E]/70 mt-1 max-w-[200px] leading-relaxed">Track urgent pickups, NGOs, donors, and demand hotspots.</p>
             </div>
             
             {/* Map SVG drawing */}
             <div className="flex-1 w-full h-full bg-[#FDFBF7] relative overflow-hidden">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#33251E]/10 p-8 flex flex-col h-[560px]">
             <span className="text-[11px] font-bold text-[#F07154] uppercase tracking-[0.1em] mb-3 flex items-center gap-1.5">
             ...
             <p className="text-sm text-[#33251E]/70 mt-2 mb-6">25 kg • Bhopal Grand Hotel</p>
             ...
             <div className="space-y-4 flex-1">
                <div className="flex justify-between items-center py-3 border-b border-[#33251E]/5">
                ...
                <div className="flex justify-between items-center py-3 border-b border-[#33251E]/5">
                   <span className="text-[11px] font-bold text-[#33251E]/40 uppercase tracking-widest">Suggested route</span>
                   <span className="text-sm font-semibold text-[#33251E] text-right">MP Nagar →<br/>Habibganj</span>
                </div>
             </div>
             
             <div className="flex gap-3 mt-6">
               <button className="flex-1 bg-[#F07154] hover:bg-[#E05F42] text-white rounded-xl py-3.5 text-sm font-bold flex items-center justify-center gap-2 transition-colors shadow-sm">
                 <RouteIcon size={18} /> Navigate
               </button>
               <button className="bg-[#FDFBF7] border border-[#33251E]/10 hover:border-[#33251E]/30 text-[#33251E] rounded-xl px-5 py-3.5 flex items-center justify-center transition-colors">
                 <Phone size={18} />
               </button>
             </div>
          </div>
