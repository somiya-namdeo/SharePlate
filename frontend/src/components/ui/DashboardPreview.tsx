...
export function DashboardPreview() {
  return (
    <div className="bg-white rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-[#33251E]/5 overflow-hidden w-full antialiased">
      {/* Window Controls */}
      <div className="px-5 py-3 border-b border-[#33251E]/5 flex items-center justify-between bg-white/50 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#F07154]/10 text-[#F07154] text-[10px] font-bold uppercase tracking-wide">
          <Sparkles size={12} />
          AI Assisted
        </div>
      </div>
      ...
      <div className="p-6 bg-[#FDFBF7]/30">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-4 rounded-xl border border-[#33251E]/10 shadow-sm">
            <div className="text-[10px] text-[#33251E]/50 uppercase tracking-wider font-semibold mb-2">Active Donations</div>
            <div className="font-serif text-3xl text-[#33251E] font-medium">24</div>
          ...
          <div className="bg-white p-4 rounded-xl border border-[#33251E]/10 shadow-sm">
            ...
            <div className="font-serif text-3xl text-[#33251E] font-medium">6</div>
          ...
          <div className="bg-white p-4 rounded-xl border border-[#33251E]/10 shadow-sm">
            ...
            <div className="font-serif text-3xl text-[#33251E] font-medium">412</div>
          ...
          <div className="col-span-3">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="bg-white p-3 rounded-xl border border-[#33251E]/10 shadow-sm flex items-center justify-between">
                  <div>
                    <div className="text-sm font-semibold text-[#33251E]">{row.item} <span className="text-[#33251E]/50 font-normal">— {row.qty}</span></div>
                    <div className="text-xs text-[#33251E]/60 mt-0.5">{row.loc}</div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className={cn("text-[10px] px-2.5 py-1 rounded-full font-bold uppercase tracking-wide", row.tag === 'Critical' ? "bg-red-100 text-red-700" : "bg-orange-100 text-orange-700")}>
                      {row.tag}
                    </span>
                    <span className={cn("text-[10px] px-2.5 py-1 rounded-full font-bold uppercase tracking-wide", row.safe === 'Safe' ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700")}>
                      {row.safe}
                    </span>
                  </div>
                </div>
        ...
        {/* AI Insight Bar */}
        <div className="mt-5 bg-[#F07154]/5 border border-[#F07154]/20 rounded-xl p-4 flex items-start gap-3 shadow-sm">
          <Sparkles size={16} className="text-[#F07154] mt-0.5 flex-shrink-0" />
          <p className="text-sm text-[#33251E]/90 leading-snug">
            <span className="font-bold text-[#F07154]">AI Insight:</span> Zone B needs 120 dinner meals tonight — 3 nearby donors are surplus-ready.
          </p>
        </div>
      </div>
    </div>
