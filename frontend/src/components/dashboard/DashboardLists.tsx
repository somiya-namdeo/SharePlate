...
const SectionWrapper = ({ title, label, link, className = "", children }: any) => (
...
export function ActiveMatchesList({ matches, role, className = "" }: { matches: any[], role: string, className?: string }) {
  return (
    <SectionWrapper title="Active Matches" label="In Progress" link="/matches" className={className}>
      {matches.length === 0 ? (
...
export function RecentRequestsList({ requests, className = "" }: { requests: any[], className?: string }) {
  return (
    <SectionWrapper title="My Recent Requests" label="Your Needs" link="/requests" className={className}>
      {requests.length === 0 ? (
...
export function DonationList({ donations, title, label, emptyDesc, className = "" }: { donations: any[], title: string, label: string, emptyDesc: string, className?: string }) {
  return (
    <SectionWrapper title={title} label={label} link="/donations" className={className}>
      {donations.length === 0 ? (
